...
#################################################
# file to edit: O_greyhat_Art_Generation_with_Neural_Style_Transfer.ipynb͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏︍͏󠄀͏︍
...
os.chdir(r"F:\Programming\CourseraDL\T_Repo\C4_W4_Assignment2\Files\tf\W4A2")
...
content_image = Image.open("images/content.jpeg")
...
example = Image.open("images/sandstone.jpg")
example
...
content_image = np.array(Image.open("images/content.jpeg").resize((img_size, img_size)))
